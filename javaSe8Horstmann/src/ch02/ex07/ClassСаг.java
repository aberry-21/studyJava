 ...
 *
 * Ответ:
 * Класс считается неизменяемым, если построенные однажды его экземпляры
 * не подлежат дальнейшим изменениям.
 * Мы изменяем топливо/дистанцию у объекта => класс изменяемый
 */
